...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new project.date.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new project.date.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new project.date.Button();
        cmdPrevious = new project.date.Button();
        slide = new project.date.Slider();

        setBackground(new java.awt.Color(255, 255, 255));

        header.setBackground(new java.awt.Color(43, 0, 136));
        ...
        cmdMonth.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 14)); // NOI18N
        ...
        lb.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 12)); // NOI18N
        ...
        cmdYear.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 14)); // NOI18N
    ...
    private project.date.Button cmdForward;
    private project.date.Button cmdMonth;
    private project.date.Button cmdPrevious;
    private project.date.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private project.date.Slider slide;
